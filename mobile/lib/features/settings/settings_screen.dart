            ...
            child: AppCard(
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    leading: const Icon(Icons.receipt_long_outlined),
                    title: Text(context.t('Sales tax')),
                    subtitle: const Text('FBR return, further tax, Annexure C'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.goNamed(Routes.tax),
                  ),
                  const Divider(height: 1),
                  ListTile(
                    leading: const Icon(Icons.card_giftcard_outlined),
                    title: Text(context.t('Loyalty points')),
                    subtitle: const Text('Give regular customers a reason to come back'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.goNamed(Routes.loyalty),
                  ),
                  const Divider(height: 1),
                  ListTile(
                    leading: const Icon(Icons.blender_outlined),
                    title: Text(context.t('Making things')),
                    subtitle: const Text('Recipes that turn raw stock into finished stock'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.goNamed(Routes.manufacturing),
                  ),
                  const Divider(height: 1),
                  ListTile(
                  ...
                  ListTile(
                    ...
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => context.goNamed(Routes.pricing),
                  ),
                  const Divider(height: 1),
                  ListTile(
